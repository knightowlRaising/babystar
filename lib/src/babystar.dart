          ...
          if (star1.toInt() != 0)
            AnimatedSwitcher(
              ...
              child: SVGWidget(
                ...
                width: 300,
                key: UniqueKey(),
                path: 'assets/starr/1-${star1.toInt()}-01.svg',
                color: purple,
                enableColor: true,
              ),
            ),
          if (star2.toInt() != 0)
            AnimatedSwitcher(
              ...
              child: SVGWidget(
                ...
                width: 300,
                key: UniqueKey(),
                path: 'assets/starr/2-${star2.toInt()}-01.svg',
                color: orange,
                enableColor: true,
              ),
            ),
          if (star3.toInt() != 0)
            AnimatedSwitcher(
              ...
              child: SVGWidget(
                ...
                width: 300,
                key: UniqueKey(),
                path: 'assets/starr/3-${star3.toInt()}-01.svg',
                color: teal,
                enableColor: true,
              ),
            ),
          if (star4.toInt() != 0)
            AnimatedSwitcher(
              ...
              child: SVGWidget(
                ...
                width: 300,
                key: UniqueKey(),
                path: 'assets/starr/4-${star4.toInt()}-01.svg',
                color: yellow,
                enableColor: true,
              ),
            ),
          if (star5.toInt() != 0)
            AnimatedSwitcher(
              ...
              child: SVGWidget(
                ...
                width: 300,
                key: UniqueKey(),
                path: 'assets/starr/5-${star5.toInt()}-01.svg',
                color: red,
                enableColor: true,
              ),
            ),
